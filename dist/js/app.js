  ...
  (() => {
        ...
        e.forEach((e) => {
          ...
          n.forEach((e, t) => {
            e.addEventListener("change", function (e) {
              ((e, t) => {
                let s = [null, null];
                (s[e] = t), console.log(s), i.noUiSlider.set(s);
        ...
        if (
          ...
          document.querySelector(".main-block") &&
            new vs(".main-block__slider", {
              ...
              speed: 800,
              loop: !0,
              pagination: { el: ".control-main-block__dotts", clickable: !0 },
              on: {
                init: function (e) {
    ...
    new As("max").init(),
      (Ls = function () {
        ...
        function r(e, s, n, r, a, o, l, c, d, u, p, f) {
          var h,
            m,
            g,
            v = f,
        ...
        function a(e, t, n, r, a, o, l, c, d, u, p, f) {
          var h,
            m = "";
          return (
            p && (f = p(f)),
